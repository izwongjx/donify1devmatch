    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="glass-card p-8 rounded-3xl w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2 drop-shadow-lg">Donor Login</h1>
        ...
        <div className="mt-6 text-center">
          <p className="text-white/90 drop-shadow-md">
            ...
            <Link to="/donor/register" className="text-white font-semibold hover:underline">
              Register here
            </Link>
          </p>
        </div>
